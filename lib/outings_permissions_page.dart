...
import 'package:student_app/outing_details_page.dart';
import 'package:student_app/profile_page.dart';
import 'package:student_app/services/outing_service.dart';
...
class _OutingsPermissionsPageState extends State<OutingsPermissionsPage> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final data = await OutingService.getOutings();
      if (mounted) {
        setState(() {
          _outings = data;
          _calculateStats();
  ...
  Widget _buildRuleItem(BuildContext context, String text, {bool isLast = false}) {
                              ...
                              children: [
                                ...
                                ..._outings.map((r) {
                                  ...
                                  if (status == 'approved') {
                                    ...
                                    statusBg = Colors.red.withValues(
                                      alpha: 0.1,
                                    );
