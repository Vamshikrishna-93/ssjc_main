...
import 'package:student_app/documents_page.dart';
import 'package:student_app/exams_page.dart';
import 'package:student_app/home_dashboard.dart';
import 'package:student_app/hostel_attendence_page.dart';
import 'package:student_app/hostel_fee_page.dart';
import 'package:student_app/outings_permissions_page.dart';
                    ...
                    _DashboardCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const HostelAttendancePage(),
                          ),
                        );
                      },
                    ),
                    _DashboardCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const HostelFeesPage(),
                          ),
                        );
                      },
                    ),
                    ...
                    _DashboardCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const OutingsPermissionsPage(),
                          ),
                        );
                      },
                    ),
